...
const analyzeContentWithGemini = async (text, mediaUrls) => {
  ...
  let inputText = `Analise o seguinte conteúdo para verificar se contém material adulto (+18) ou Qualquer descurso de odio, como Se Mata, Smt, Morre e ETC. e nao deixe passar palavras tipo S3 M4t4 ou Isso Tambem, Eu quero que você morra: "${text}". Responda apenas com "SEGURO" ou "NÃO SEGURO".`;
