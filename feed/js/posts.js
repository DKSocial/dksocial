...
const postTweet = async () => {
  ...
  try {
    ...
    const platform = getPlatform(); // Captura a plataforma
    ...
    await db.collection('tweets').add({
      ...
      platform // Adiciona a plataforma ao tweet
    });
...
const renderTweet = (tweet) => {
  ...
  tweetElement.innerHTML = `
    <div class="tweet__header">
      ...
      <span class="tweet__platform">Lip Feito Em ${tweet.platform}</span> <!-- Exibe a plataforma -->
    </div>
